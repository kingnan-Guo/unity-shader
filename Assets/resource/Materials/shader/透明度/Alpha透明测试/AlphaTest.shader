Shader "Unlit/AlphaTest"
{
    Properties
    {
        ...
        _Cutoff("Alpha Cutoff", Range(0, 1)) = 0.5 // 透明度
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed3 diffuse = _LightColor0.rgb * texColor.rgb * _Diffuse.rgb * (max(0, dot(worldLightDir, i.worldNormal)) * 0.5 + 0.5);
